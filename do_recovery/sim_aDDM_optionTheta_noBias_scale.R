...
if (mydata ==   'gaia_risk'){
  val_scale_factor <-100
}else if (mydata ==   'stewart_risk'){
  val_scale_factor <-500}
...
sourceCpp(paste(recovery_folder, "/aDDM_", typename ,".cpp" ,sep=""))
# ==========================================================================
### Simulations ###
...
data_trial$val_A_scaled <- data_trial$val_A/val_scale_factor
data_trial$val_B_scaled <- data_trial$val_B/val_scale_factor
